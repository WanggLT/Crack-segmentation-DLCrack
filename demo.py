...
NETS = {'vgg16': ('vgg16',), 'res101': ('res101_faster_rcnn_iter_110000.ckpt',)}
...
def vis_detections(im, class_name, dets, thresh=0.7):
    ...
    inds = np.where((dets[:, -1] >= thresh) & (dets[:, -1] <= 0.8))[0]
    if len(inds) == 0:
        return
...
if __name__ == '__main__':
    ...
    im_names = ['0000166.jpg', '0000212.jpg', '0000257.jpg', '0000259.jpg',
                '0000287.jpg', '0000349.jpg']
