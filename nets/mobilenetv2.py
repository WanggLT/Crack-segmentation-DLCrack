...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        interverted_residual_setting = [
            # t, c, n, s
            [1, 16, 1, 1], # 128, 128, 32 -> 128, 128, 16
            [6, 24, 2, 2], # 128, 128, 16 -> 64, 64, 24   2
            [6, 32, 3, 2], # 64, 64, 24 -> 32, 32, 32     4
            [6, 64, 4, 2], # 32, 32, 32 -> 32, 32, 64       7
            [6, 96, 3, 1], # 32, 32, 64 -> 32, 32, 96
            [6, 160, 3, 2], # 32, 32, 96 -> 32, 32, 160     14
            [6, 320, 1, 1], # 32, 32, 160 -> 32, 32, 320
        ]
